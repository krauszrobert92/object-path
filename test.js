...
describe('ObjectPath', function () {
	...
	describe('push', function () {
		...
		it('should push object to existing array using path', function () {
			var obj = getTestObj();
			objectPath.push(obj, "b.c", { id: "testId1", value: "testValue1" });
			objectPath.push(obj, "b.c", { id: "testId2", value: "testValue2" });
			var value1 = objectPath.get(obj, "b.c.{id:testId1}.value");
			var value2 = objectPath.get(obj, "b.c.{id:testId2}.value");

			expect(value1).to.be.equal("testValue1");
			expect(value2).to.be.equal("testValue2");
		});

		it('should push object to not existing array using path', function () {
			var obj = getTestObj();
			objectPath.push(obj, "b.g", { id: "testId1", value: "testValue1" });
			objectPath.push(obj, "b.g", { id: "testId2", value: "testValue2" });
			var value1 = objectPath.get(obj, "b.g.{id:testId1}.value");
			var value2 = objectPath.get(obj, "b.g.{id:testId2}.value");
			var newArray = objectPath.get(obj, "b.g");
	...
	describe('del', function () {
		...
		it('should remove items from nested array by id', function () {
			var obj = {
				a: [
			...
			objectPath.del(obj, 'a.{id:testId1}');
			expect(obj.a).to.have.length(1);
			expect(obj.a).to.be.deep.equal([{ id: "testId2", name: "testName2" }]);
